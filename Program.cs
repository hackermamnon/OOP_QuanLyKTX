    ...
    class Program
    {
        ...
        public static void Linq16()
        {
            ...
            var hd = dsHopDong
                ...
                .Select(y => new { sv = y });
            foreach (var i in hd)
                Console.WriteLine("Mã SV: {0} - Họ tên: {1} - SĐT: {2} - Ngày ký HĐ: {3} ", 
                    i.sv.maSinhVien, i.sv.sinhVien.tenSV, i.sv.sinhVien.soDienThoai, i.sv.ngayKyHopDong.ToShortDateString());
            Console.WriteLine();
        }
